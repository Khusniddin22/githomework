...
## Декораторы
Был создан декоратор 'log', который автоматически логирует начало и конец выполнения функции, а также ее результаты или возникшие ошибки.
Также были проведены тесты над декоратором

    ...
    # Работа с CSV-файлом
        ...
        while True:
            ...
            if user_input in ("Да", "Нет"):
                if user_input == "Да":
                    df_state_csv = [
                        transaction for transaction in df_state_csv if transaction["currency_code"] == "RUB"
                    ]
                else:
                    pass
                break
    ...
    # Работа с Excel-файлом
        ...
        while True:
            ...
            if user_input in ("Да", "Нет"):
                if user_input == "Да":
                    df_state_excel = [
                        transaction for transaction in df_state_excel if transaction["currency_code"] == "RUB"
                    ]
                else:
                    pass
                break
